...
fourth_most_frequent_genre = genre_counts.index[3]

# Filter the dataset for the fourth most frequent genre
genre_data = df[df['Genre'] == fourth_most_frequent_genre]
...
plt.plot(grouped['Year'], grouped['Count'], label=fourth_most_frequent_genre)
plt.xlabel('Year')
plt.ylabel('Frequency')
plt.title('Genre Count Over the Years - Fourth Top Genre: '+ fourth_most_frequent_genre)
plt.legend()
plt.show()
